...
public class ViewAdapter extends PagerAdapter {
    ...
    final String tip4 = "There are 4 workouts for you to choose, I recommend on doing 3 of them every week with at least 48 hours between each workout.\nYou can train your abs on your rest days!";
    final String tip5 = "your Max weight in an exercise is the maximum weight you can do 4-6 reps in that specific exercise.";
    ...
    final String tip7 = "The most important exercises to put effort into are:\nPull up, Bench press, Squat, Deadlift, Dips (these exercises increase testosterone levels).";
